...
sudo docker run -it --rm -v $(pwd)/my_test_data:/data -v $(pwd)/my_test_config:/config -p 8099:8099 -p 8090:8090 --device=$DEV_VIDEO:/dev/video0 --entrypoint /bin/sh local/octoprint_test
